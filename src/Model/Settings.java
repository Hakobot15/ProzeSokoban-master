...
public class Settings {
    /**
     * @parm lives przechowuje odczytana wartosc ilosci posiadanych zyc przez gracza
     */
    private static int lives;
    /**
     * @parm pointScale przechowuje odczytana wartosc przelicznika punktow
     */
    private static int pointScale;
    /**
     * @parm timeScale przechowuja odczytana wartosc przeskalowania czasu
     */
    ...
    public Settings(String nazwaPliku) {
        ...
        for (int i = 0; i < settingFile.getDataList().size(); i++) {
            ...
            /**
             * Case1 - w pliku znajduje sie dany string i posiada przypisana wartosc
             */
            if (tmp.startsWith(DEFAULT_LIVES) && tmp.length() > DEFAULT_LIVES.length()) {
                ...
                break;
                /**
                 * Case2 - w pliku znaduje sie dany string ale nie ma przypisanych wartosc
                 */
